				...
				<div id="Beta">
					...
					<?php endif ?>
						...
						<div id="top-contents-main">
							<div id="top-main-telfax-title">お気軽にお問い合わせ下さい　（月曜休館日）</div>
							<div id="top-main-telfax-left">
								<div id="top-main-telfax-tel">
									<p class="top-tel">TEL 0250-24-5776</p>
									<p class="top-tel-time">受付時間<br>9:00〜22:00</p>
								</div>
								<div id="top-main-telfax-fax">
									<p class="top-fax">FAX 0250-24-5776</p>
